...
public class RobotContainer
{
  ...
  //private final JoystickButton intakehmanplayerButton = new JoystickButton(operator, XboxController.Button.kRightBumper.value);
   private final JoystickButton AMPButton = new JoystickButton(driverXbox, XboxController.Button.kLeftStick.value);
      ...
      private final JoystickButton autointake = new JoystickButton(driverXbox, XboxController.Button.kX.value);
           ...
           private final JoystickButton zerogyro = new JoystickButton(driverXbox, XboxController.Button.kA.value);
  ...
  public RobotContainer()
  {
    ...
    autochooser.addOption("AMP", new PathPlannerAuto("AMPy"));
        NamedCommands.registerCommand("runintake", Intake.intakeandfeeder(0.7, -0.7));
    NamedCommands.registerCommand("pullback", Intake.intakeandfeederauto(0,0.4 ,.4));
        NamedCommands.registerCommand("pullbacko", Projectile.Outtake(-1));
        

    NamedCommands.registerCommand("runintake2", Intake.intakeandfeederauto(0.8,-.80,.5));
    NamedCommands.registerCommand("boxpivclose",Pivoit.boxpivcmdAU(-8.8736328125));
    NamedCommands.registerCommand("boxpivfar",Pivoit.boxpivcmdAU1(-4.2));
    NamedCommands.registerCommand("boxpivfar1",Pivoit.boxpivcmdAU1(-4.0));
    NamedCommands.registerCommand("boxpivfar2",Pivoit.boxpivcmdAU1(-6.0));
    NamedCommands.registerCommand("shoot",Projectile.OtakeAU(.7));
   ...
   // autoChooser.addOption("3 Piece Stage Side", new PathPlannerAuto("Copy of 3 Piece AMP Side"));
        autochooser.addOption("2 piece amp", new PathPlannerAuto("2 Piece AMP Side"));
         ...
         autochooser.addOption("Skibidi", new PathPlannerAuto("Skibidi"));
  ...
  private void configureBindings()
  {
    ...
    subwooferpiv.whileTrue(new ParallelCommandGroup(Pivoit.boxpivcmdTO(-8.1), Projectile.Outtake(0.65)))
      .whileFalse(new ParallelCommandGroup(Projectile.Outtake(0), Pivoit.boxpivcmdTO(0)));
